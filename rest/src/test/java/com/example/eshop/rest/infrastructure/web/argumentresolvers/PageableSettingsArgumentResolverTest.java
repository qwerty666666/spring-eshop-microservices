...
class PageableSettingsArgumentResolverTest {
    private PageableSettingsArgumentResolver resolver;

    @BeforeEach
    void setUp() {
        resolver = new PageableSettingsArgumentResolver(Optional.empty(), Optional.empty());
    }
