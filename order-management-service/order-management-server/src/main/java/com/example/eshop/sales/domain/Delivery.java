...
public class Delivery {
    ...
    public Delivery(String deliveryServiceId, String name, Address address, Money price) {
        Assertions.notEmpty(deliveryServiceId, "deliveryServiceId must be not empty");
